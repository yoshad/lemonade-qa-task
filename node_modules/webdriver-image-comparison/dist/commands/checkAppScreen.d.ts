 ...
 */
export default function checkAppScreen({ methods, instanceData, folders, tag, checkScreenOptions, isNativeContext, testContext, }: InternalCheckScreenMethodOptions): Promise<ImageCompareResult | number>;
