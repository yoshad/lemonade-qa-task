 ...
 */
export declare function determineIgnoreRegions(ignores: (RectanglesOutput | WebdriverIO.Element | ChainablePromiseElement)[], getElementRect: GetElementRect): Promise<RectanglesOutput[]>;
/**
