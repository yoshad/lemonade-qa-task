...
export class SnapshotService {
    ...
    async beforeStep(step, scenario) {
        ...
        await __classPrivateFieldGet(this, _SnapshotService_snapshotClient, "f").startCurrentRun(file, testName, __classPrivateFieldGet(this, _SnapshotService_options, "f"));
    }
    async after() {
